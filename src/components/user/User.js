...
function User({ image, name, userId, isPopup = false }) {
    ...
    return (
        ...
        <div className='flex items-center space-x-2'>
            ...
            <div onClick={onClick} className={`w-full relative flex items-center flex-row gap-2 px-2 pr-5 py-1 rounded-md hover:bg-[#6b6a6a] hover:transition-all ${userId === params?.userid && 'bg-[#373737]'}`}>
                <img
                    alt=""
                    src={image}
